...
part "market_detail_api_service.chopper.dart";

@ChopperApi(baseUrl: '/market/')
abstract class MarketDetailApiService extends ChopperService{

  static MarketDetailApiService create(){
    final client = ChopperClient(
        baseUrl: API_URL_STARTPOINT,
        services: [_$MarketDetailApiService()],
        converter: JsonToTypeConverter({
          StoreModel: (jsonData) => StoreModel.fromJson(jsonData)
        })
    );
    return _$MarketDetailApiService(client);
  }
  @Get(path: "{store_id}")
  Future<Response<StoreModel>> getStoreByID(@Path() String store_id);
