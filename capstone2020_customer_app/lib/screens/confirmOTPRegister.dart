...
class ConfirmOTPRegisterPage extends StatefulWidget {
  final String phoneNumber;

  ConfirmOTPRegisterPage({Key key, @required this.phoneNumber}) : super(key: key);

  @override
  _ConfirmOTPRegisterPage createState() => _ConfirmOTPRegisterPage(phoneNumber);
}



class _ConfirmOTPRegisterPage extends State<ConfirmOTPRegisterPage> {
  String phoneNumber;

  _ConfirmOTPRegisterPage(this.phoneNumber);
  String email;
          ...
          onPressed: () async {
            ...
            if(response.statusCode == 200){
              ...
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (_) => ConfirmOTPRegisterPage(phoneNumber: phoneNumber,)));
            }else{
...
//    print(' ${post.toString()}');
    ...
    final myService = OTPApiService.create();
    final response = await myService.confirmOTPCode(phoneNumber, OTPController.text);
    if(response.statusCode == 200){
      showSuccessToast();
